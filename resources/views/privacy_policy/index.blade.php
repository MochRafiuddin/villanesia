...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4>Data Privacy Policy</h4><br>                
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('privacy-policy/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("privacy-policy/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('privacy-policy/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('privacy-policy/show')}}/"+data;
            }         
          },
      });
    }
