...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4>Data Promosi Kendaraan</h4><br>
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('promosi-kendaraan/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
    $(document).ready(function () {
        ...
        function read_data() {
            $('table').DataTable({
                ...
                "scrollX": true,
                ajax: {
                    url: '{{ url("promosi-kendaraan/data") }}',
                },
                rowReorder: {
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("promosi-kendaraan/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('promosi-kendaraan/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('promosi-kendaraan/show')}}/"+data;
            }         
          },
      });
    }
