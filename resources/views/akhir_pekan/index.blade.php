            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('akhir-pekan/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("akhir-pekan/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('akhir-pekan/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('akhir-pekan/show')}}/"+data;
            }         
          },
      });
    }
