...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4>Data Concierge Service</h4><br>
                <div class="row">
                ...
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('concierge-service/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
    $(document).ready(function () {
        ...
        function read_data() {
            ...
            $('table').DataTable({
                ...
                "scrollX": true,
                ajax: {
                    url: '{{ url("concierge-service/data") }}',
                    type: 'GET',
                    data: {
                        bahasa : bahasa,
                    }
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("concierge-service/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('concierge-service/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('concierge-service/show')}}/"+data;
            }         
          },
      });
    }
