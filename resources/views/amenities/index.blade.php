            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('amenities/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("amenities/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('amenities/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('amenities/show')}}/"+data;
            }         
          },
      });
    }
