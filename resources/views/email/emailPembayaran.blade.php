							...
							<div style="width:600px;margin:0px auto;background-color:#ffffff;border-radius:8px">
								...
								<div style="padding:56px 32px 48.4px">
									...
									<div>
                                        ...
                                        <p style="line-height:1.5rem;letter-spacing:0;font-size:16px;color:#35405a;margin-top:16px"> We have received payment for your order. Now you can enjoy all the services from us according to your order.</p>
                                        <p style="line-height:1.5rem;letter-spacing:0;font-size:16px;color:#35405a;margin-top:16px"> Thank you for choosing Villanesia</p>
