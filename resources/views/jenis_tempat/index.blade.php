            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col text-right">                        
                        <a href="{{url('jenis-tempat/create')}}" class="btn btn-info">Tambah</a>                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
...
<script>
        ...
        function read_data() {
            ...
            $('table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'nama_jenis_tempat',
                        name: 'nama_jenis_tempat',                        
                    },
                    {
                        data: 'action',
                        name: 'action',
    ...
    function myFunction(kode) {
        ...
        $.ajax({
            url: '{{ url("jenis-tempat/bahasa") }}',
            type: 'get',
            data: { id:id, id_ref:id_ref, kode:kode},
            dataType: 'json',
          success: function (data) {            
            if (data == 'tambah') {
                window.location = "{{url('jenis-tempat/create-bahasa')}}/"+id+"/"+kode;
            }else{
                window.location = "{{url('jenis-tempat/show')}}/"+data;
            }         
          },
      });
    }
